fuhHnction varargout = hideGui(varargin)
%HIDEGUI M-file for hideGui.fig
...
%
%      HIDEGUI('Property','Value',...) creates a new HIDEGUI using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to hideGui_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      HIDEGUI('CALLBACK') and HIDEGUI('CALLBACK',hObject,...) call the
%      local function named CALLBACK in HIDEGUI.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 21-Nov-2017 14:58:58
